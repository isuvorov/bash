...
echo "ssh ${SERVER} \"${SERVER_PREFIX}$cmd\" | lsklog -o short ${@:3}"
# ssh ${SERVER} ${SERVER_PREFIX}$cmd | ~/bash/bunyan.js -o short ${@:3}
ssh ${SERVER} ${SERVER_PREFIX}$cmd | /Users/isuvorov/projects/lskjs/packages/log2/build/bin/lsklog.js -o short ${@:3}
# -l trace
